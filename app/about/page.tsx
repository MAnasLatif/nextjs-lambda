        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              This is a demonstration of deploying Next.js applications to AWS Lambda using the Serverless Framework.
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-purple-50 dark:bg-gray-700 rounded-lg p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  This application uses Next.js in standalone mode, packaged and deployed as an AWS Lambda function. 
                  The Serverless Framework handles all the infrastructure provisioning automatically.
                </p>
              </div>
